package com.ielee.allin.springboot.common.ioc;

import com.ielee.allin.springboot.common.exception.IocInstanceNotFoundException;
import com.ielee.allin.springboot.common.exception.IocInstanceNotUniqueException;
...
public class InstanceFactory {
    ...
    public static <T> T getInstance(Class<T> beanType) {
        ...
        result = (T) INASTANCE.get(beanType);
        if (result != null) {
            return result;
        }
    ...
    public static <T> T getInstance(Class<T> beanType, String beanName) {
        ...
        result = (T) INASTANCE.get(toName(beanType, beanName));
        if (result != null) {
            return result;
        }
        throw new IocInstanceNotFoundException("There's not bean of type '" + beanType + "' exists in IoC container!");
    ...
    public static <T> T getInstance(Class<T> beanType, Class<? extends Annotation> annotationType) {
        ...
        result = (T) INASTANCE.get(toName(beanType, annotationType));
        if (result != null) {
            return result;
        }
     ...
     */
    private static final Map<Object, Object> INASTANCE = new HashMap<Object, Object>();
    ...
    public static <T> void bind(Class<T> serviceInterface, T serviceImplementation) {
        INASTANCE.put(serviceInterface, serviceImplementation);
    }
    ...
    public static <T> void bind(Class<T> serviceInterface, T serviceImplementation, String beanName) {
        INASTANCE.put(toName(serviceInterface, beanName), serviceImplementation);
    }
    ...
    public static <T> void bind(Class<T> serviceInterface, T serviceImplementation, Class<? extends Annotation> annotationType) {
        INASTANCE.put(toName(serviceInterface, annotationType), serviceImplementation);
    }
